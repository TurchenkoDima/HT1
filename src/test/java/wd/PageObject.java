...
public class PageObject {
    ...
    @FindBy(linkText = "Manage Jenkins")//Настроить Jenkins
    private WebElement linkManageJenkins;

    @FindBy(xpath = "//dt[text()='Manage User']")//Управление пользователями
    ...
    private WebElement ddCreatUser;

    @FindBy(xpath = "//a[text() = 'Create User']")//Создать пользователя
    private WebElement linkCreatUser;
    ...
    @FindBy(xpath = "//button[@type = 'button' and text() = 'Create User']")//Создать пользователя
    ...
    @FindBy(xpath = "//a[text() = 'ENABLE AUTO REFRESH']")//Включить автообновление страниц
    private WebElement linkEnableAutoRefresh;

    @FindBy(xpath = "//a[text() = 'DISABLE AUTO REFRESH']")//Отключить автообновление страниц
    ...
    public boolean isThereCreateJenkinsdd() {
        return isElementPresent(ddCreatUser);
    }
    ...
    public boolean isThereCreateUserlink() {
        return isElementPresent(linkCreatUser);
    }
    ...
    public boolean clickCreateUser() {
        if(isElementPresent(linkCreatUser)){
            linkCreatUser.click();
            return true;
        }
        return false;
